						...
						<div class="titlebar-col col-md-12 bg-white pt-10 bg-white box-shadow-1">
							<div class="row">
								...
								<div class="col-md-2 col-md-offset-1">
									<h6 class="font-size-14 font-weight-medium text-uppercase ltr-sp-2">USERS</h6>
								</div><!-- /.col-md-2 -->
...
<script>
     $.fn.get_Admin_Users = function(){ 
		var resultJson = null;
	$.get('api/admin_get_site_users.php',{},function(result){
    ...
    if(!row.hasClass('footable-paging')){
	  ...
	  $.get('api/admin_get_single_site_user.php',{
		  id:collected_id
	  },function(result){
		...
		<div class='col-md-5'>Name: `+resultJson.name+` </div><div class='col-md-5'>Email: `+resultJson.email+` </div>
		<div class='col-md-5'>Phone No: `+resultJson.phone+`</div><div class='col-md-5'>Gender: `+resultJson.gender+`</div>
		<div class='col-md-5'>State: `+resultJson.state+`</div><div class='col-md-5'>Date: `+resultJson.reg_date+`</div>
		</div>`,
        blockScroll:false,
        confirm: function(){
