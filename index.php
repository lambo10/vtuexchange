...
<body data-mobile-nav-trigger-alignment="right" data-mobile-nav-align="left" data-mobile-nav-style="modern" data-mobile-nav-shceme="gray" data-mobile-header-scheme="gray" data-mobile-nav-breakpoint="1199">
    ...
    ?>
		...
		<main id="content" class="content">
			...
			<section class="vc_row fullheight d-flex flex-wrap align-items-center bg-cover pt-150 pb-150" style="background-image: url(./assets/demo/bg/bg-14.jpg);" data-parallax="true" data-parallax-options='{ "parallaxBG": true }'>
				...
				<div class="container">
					<div class="row">
						...
						<div
							...
							<ul class="social-icon scheme-white social-icon-md mt-70 mb-150">
								<li><a href="#" class="opacity-05 reset-opacity-onhover" target="_blank"><i class="fa fa-facebook"></i></a></li>
								<li><a href="#" class="opacity-05 reset-opacity-onhover" target="_blank"><i class="fa fa-behance"></i></a></li>
								<li><a href="#" class="opacity-05 reset-opacity-onhover" target="_blank"><i class="fa fa-dribbble"></i></a></li>
								<li><a href="#" class="opacity-05 reset-opacity-onhover" target="_blank"><i class="fa fa-instagram"></i></a></li>
							</ul>
						...
						<div  class="carousel-container carousel-shadow-active carousel-nav-left carousel-nav-md carousel-dots-style1">
							<div class="carousel-items row" data-lqd-flickity='{"wrapAround": true}'>
								...
								<div class="lqd-column w-20 text-center px-2">
									<figure>
										<img src="./images/mtn.png" alt="Client">
									</figure>
								</div><!-- /.lqd-column w-20 text-center px-2 -->

								<div class="lqd-column w-20 text-center px-2">
									<figure>
										<img src="./images/glo.png" alt="Client">
									</figure>
								</div><!-- /.lqd-column w-20 text-center px-2 -->

								<div class="lqd-column w-20 text-center px-2">
									<figure>
										<img src="./images/airtel.png" alt="Client">
									</figure>
								</div><!-- /.lqd-column w-20 text-center px-2 -->

								<div class="lqd-column w-20 text-center px-2">
									<figure>
										<img src="./images/9mobile.png" alt="Client">
									</figure>
								</div><!-- /.lqd-column w-20 text-center px-2 -->

								<div class="lqd-column w-20 text-center px-2">
									<figure>
										<img src="./images/dstv.png" alt="Client">
									</figure>
								</div><!-- /.lqd-column w-20 text-center px-2 -->

								<div class="lqd-column w-20 text-center px-2">
									<figure>
										<img src="./images/smile.png" alt="Client">
									</figure>
								</div><!-- /.lqd-column w-20 text-center px-2 -->

								<div class="lqd-column w-20 text-center px-2">
									<figure>
										<img src="./images/aedc.png" alt="Client">
									</figure>
								</div><!-- /.lqd-column w-20 text-center px-2 -->

								<div class="lqd-column w-20 text-center px-2">
									<figure>
										<img src="./images/spectranet.png" alt="Client">
									</figure>
								</div><!-- /.lqd-column w-20 text-center px-2 -->
			...
			<section id="services" class="vc_row  bg-no-repeat" style="background-image: url(./assets/demo/bg/bg-77.svg); background-position: 500% 0%;">
				<div class="container">
					...
					<div id="works" class="row">
								...
								<div class="row d-flex flex-wrap align-items-end mb-40">
									<div class="col-md-6">
										<header class="fancy-title mb-0">
											...
											<h2><strong>Virtual </strong> Top Up</h2>
										</header>
									</div><!-- /.col-md-6 -->
								</div><!-- /.row -->
						...
						<div class="lqd-column col-lg-3 col-md-4 col-sm-6 col-xs-12 masonry-item">
							...
							<article class="liquid-lp liquid-blog-item liquid-blog-contents-inside liquid-blog-item-masonry liquid-blog-scheme-light liquid-blog-cloned-title h-300">
								...
								<figure class="liquid-lp-media" style="background-image: url(images/data.jpg);">
									<a href="buyData.php">
								...
								<div class="liquid-blog-item-inner">
									...
									<a href="buyData.php" class="liquid-overlay-link">Buy Data Bundle</a>
								
									<header class="liquid-lp-header">
										<div class="liquid-lp-details">
											<ul class="liquid-lp-category liquid-lp-category-filled">
												<li><a href="buyData.php">Data</a></li>
											</ul>
										...
										<h2 class="liquid-lp-title size-sm font-weight-bold h3 liquid-lp-title-clone" data-fittext="true" data-fittext-options='{ "maxFontSize": "currentFontSize" }'>
											<a href="buyData.php" data-split-text="text" data-split-options='{ "type": "lines" }'>Start enjoying low rates for your internet browsing databundle</a>
										</h2>
									</header>
									...
									<footer class="liquid-lp-footer">
										<h2 class="liquid-lp-title size-sm font-weight-bold h3 liquid-lp-title-original" data-fittext="true" data-fittext-options='{ "maxFontSize": "currentFontSize" }'>
											<a href="buyData.php" data-split-text="text" data-split-options='{ "type": "lines" }'>Buy Data Bundle</a>
										</h2>
										<a href="buyData.php" class="btn btn-naked text-uppercase ltr-sp-1 size-sm font-weight-bold liquid-lp-read-more">
											<span>
						...
						<div class="lqd-column col-lg-3 col-md-4 col-sm-6 col-xs-12 masonry-item">
							...
							<article class="liquid-lp liquid-blog-item liquid-blog-contents-inside liquid-blog-item-masonry liquid-blog-scheme-light liquid-blog-cloned-title h-300">
								...
								<figure class="liquid-lp-media" style="background-image: url(images/airtime.jpg);">
								...
								<div class="liquid-blog-item-inner">
									...
									<a href="buyAirtime.php" class="liquid-overlay-link">Buy Airtime</a>
								
									<header class="liquid-lp-header">
										<div class="liquid-lp-details">
											<ul class="liquid-lp-category liquid-lp-category-filled">
												<li><a href="buyAirtime.php">Airtime</a></li>
											</ul>
										</div><!-- /.liquid-lp-details -->
										<h2 class="liquid-lp-title size-sm font-weight-bold h3 liquid-lp-title-clone" data-fittext="true" data-fittext-options='{ "maxFontSize": "currentFontSize" }'>
											<a href="buyAirtime.php" data-split-text="text" data-split-options='{ "type": "lines" }'>Enjoy huge discount when you purchase airtime</a>
										</h2>
									</header>
									
									<footer class="liquid-lp-footer">
										<h2 class="liquid-lp-title size-sm font-weight-bold h3 liquid-lp-title-original" data-fittext="true" data-fittext-options='{ "maxFontSize": "currentFontSize" }'>
											<a href="buyAirtime.php" data-split-text="text" data-split-options='{ "type": "lines" }'>Buy Airtime</a>
										</h2>
										<a href="buyAirtime.php" class="btn btn-naked text-uppercase ltr-sp-1 size-sm font-weight-bold liquid-lp-read-more">
											<span>
												<span class="btn-line btn-line-before"></span>
												<span class="btn-txt">Get Started</span>
												<span class="btn-line btn-line-after"></span>
						...
						<div class="lqd-column col-lg-3 col-md-4 col-sm-6 col-xs-12 masonry-item">
							...
							<article class="liquid-lp liquid-blog-item liquid-blog-contents-inside liquid-blog-item-masonry liquid-blog-scheme-light liquid-blog-cloned-title h-300">
								...
								<figure class="liquid-lp-media" style="background-image: url(images/payElectricity.jpg);">
									<a href="buyPower.php">
										<img src="./assets/demo/latest-posts/lp-15.jpg" alt="Lates Post">
									</a>
								</figure>
								...
								<div class="liquid-blog-item-inner">
									...
									<a href="buyPower.php" class="liquid-overlay-link">Buy Power</a>
								
									<header class="liquid-lp-header">
										<div class="liquid-lp-details">
											<ul class="liquid-lp-category liquid-lp-category-filled">
												<li><a href="buyPower.php">Power</a></li>
											</ul>
										</div><!-- /.liquid-lp-details -->
										<h2 class="liquid-lp-title size-sm font-weight-bold h3 liquid-lp-title-clone" data-fittext="true" data-fittext-options='{ "maxFontSize": "currentFontSize" }'>
											<a href="buyPower.php" data-split-text="text" data-split-options='{ "type": "lines" }'>Buy power for your prepaid meter at low rates</a>
										</h2>
									</header>
									
									<footer class="liquid-lp-footer">
										<h2 class="liquid-lp-title size-sm font-weight-bold h3 liquid-lp-title-original" data-fittext="true" data-fittext-options='{ "maxFontSize": "currentFontSize" }'>
											<a href="buyPower.php" data-split-text="text" data-split-options='{ "type": "lines" }'>Buy Power</a>
										</h2>
										<a href="buyPower.php" class="btn btn-naked text-uppercase ltr-sp-1 size-sm font-weight-bold liquid-lp-read-more">
											<span>
												<span class="btn-line btn-line-before"></span>
												<span class="btn-txt">Get Started</span>
												<span class="btn-line btn-line-after"></span>
						...
						<div class="lqd-column col-lg-3 col-md-4 col-sm-6 col-xs-12 masonry-item">
							...
							<article class="liquid-lp liquid-blog-item liquid-blog-contents-inside liquid-blog-item-masonry liquid-blog-scheme-light liquid-blog-cloned-title h-300">
								...
								<figure class="liquid-lp-media" style="background-image: url(images/payCableTv.jpg);">
								...
								<div class="liquid-blog-item-inner">
									...
									<a href="buyCableTvSub.php" class="liquid-overlay-link">CableTv Subscription</a>
								
									<header class="liquid-lp-header">
										<div class="liquid-lp-details">
											<ul class="liquid-lp-category liquid-lp-category-filled">
												<li><a href="buyCableTvSub.php">TV</a></li>
											</ul>
										</div><!-- /.liquid-lp-details -->
										<h2 class="liquid-lp-title size-sm font-weight-bold h3 liquid-lp-title-clone" data-fittext="true" data-fittext-options='{ "maxFontSize": "currentFontSize" }'>
											<a href="buyCableTvSub.php" data-split-text="text" data-split-options='{ "type": "lines" }'>Instant recharge of DStv, GOtv and Startimes at affordable rates</a>
										</h2>
									</header>
									
									<footer class="liquid-lp-footer">
										<h2 class="liquid-lp-title size-sm font-weight-bold h3 liquid-lp-title-original" data-fittext="true" data-fittext-options='{ "maxFontSize": "currentFontSize" }'>
											<a href="buyCableTvSub.php" data-split-text="text" data-split-options='{ "type": "lines" }'>CableTv Subscription</a>
										</h2>
										<a href="buyCableTvSub.php" class="btn btn-naked text-uppercase ltr-sp-1 size-sm font-weight-bold liquid-lp-read-more">
											<span>
												<span class="btn-line btn-line-before"></span>
												<span class="btn-txt">Get Started</span>
												<span class="btn-line btn-line-after"></span>
						...
						<div class="lqd-column col-lg-3 col-md-4 col-sm-6 col-xs-12 masonry-item">
							...
							<article class="liquid-lp liquid-blog-item liquid-blog-contents-inside liquid-blog-item-masonry liquid-blog-scheme-light liquid-blog-cloned-title h-300">
								...
								<figure class="liquid-lp-media" style="background-image: url(images/printAirTime.jpg);">
								...
								<div class="liquid-blog-item-inner">
									...
									<a href="printRechargeCard.php" class="liquid-overlay-link">Print Recharge Cards</a>
								
									<header class="liquid-lp-header">
										<div class="liquid-lp-details">
											<ul class="liquid-lp-category liquid-lp-category-filled">
												<li><a href="printRechargeCard.php">Print Cards</a></li>
											</ul>
										</div><!-- /.liquid-lp-details -->
										<h2 class="liquid-lp-title size-sm font-weight-bold h3 liquid-lp-title-clone" data-fittext="true" data-fittext-options='{ "maxFontSize": "currentFontSize" }'>
											<a href="printRechargeCard.php" data-split-text="text" data-split-options='{ "type": "lines" }'>Easy printout for MTN, GLO, AIRTEL and 9MOBILE</a>
										</h2>
									</header>
									
									<footer class="liquid-lp-footer">
										<h2 class="liquid-lp-title size-sm font-weight-bold h3 liquid-lp-title-original" data-fittext="true" data-fittext-options='{ "maxFontSize": "currentFontSize" }'>
											<a href="printRechargeCard.php" data-split-text="text" data-split-options='{ "type": "lines" }'>Print Recharge Cards</a>
										</h2>
										<a href="printRechargeCard.php" class="btn btn-naked text-uppercase ltr-sp-1 size-sm font-weight-bold liquid-lp-read-more">
											<span>
												<span class="btn-line btn-line-before"></span>
												<span class="btn-txt">Get Started</span>
												<span class="btn-line btn-line-after"></span>
						...
						<div class="lqd-column col-lg-3 col-md-4 col-sm-6 col-xs-12 masonry-item">
							...
							<article class="liquid-lp liquid-blog-item liquid-blog-contents-inside liquid-blog-item-masonry liquid-blog-scheme-light liquid-blog-cloned-title h-300">
								...
								<figure class="liquid-lp-media" style="background-image: url(images/transferfunds.jpg);">
								...
								<div class="liquid-blog-item-inner">
									...
									<a href="transferFund.php" class="liquid-overlay-link">Transfer Funds</a>
								
									<header class="liquid-lp-header">
										<div class="liquid-lp-details">
											<ul class="liquid-lp-category liquid-lp-category-filled">
												<li><a href="transferFund.php">Transfer</a></li>
											</ul>
										</div><!-- /.liquid-lp-details -->
										<h2 class="liquid-lp-title size-sm font-weight-bold h3 liquid-lp-title-clone" data-fittext="true" data-fittext-options='{ "maxFontSize": "currentFontSize" }'>
											<a href="transferFund.php" data-split-text="text" data-split-options='{ "type": "lines" }'>Transfer funds to family and friends with a vtuexchange account</a>
										</h2>
									</header>
									
									<footer class="liquid-lp-footer">
										<h2 class="liquid-lp-title size-sm font-weight-bold h3 liquid-lp-title-original" data-fittext="true" data-fittext-options='{ "maxFontSize": "currentFontSize" }'>
											<a href="transferFund.php" data-split-text="text" data-split-options='{ "type": "lines" }'>Transfer Funds</a>
										</h2>
										<a href="transferFund.php" class="btn btn-naked text-uppercase ltr-sp-1 size-sm font-weight-bold liquid-lp-read-more">
											<span>
												<span class="btn-line btn-line-before"></span>
												<span class="btn-txt">Get Started</span>
												<span class="btn-line btn-line-after"></span>
    ...
    <article class="liquid-lp liquid-blog-item liquid-blog-contents-inside liquid-blog-item-masonry liquid-blog-scheme-light liquid-blog-cloned-title h-300">
        ...
        <figure class="liquid-lp-media" style="background-image: url(images/referral.jpg);">
            <a href="referral.php">
                <img src="./assets/demo/latest-posts/lp-15.jpg" alt="Lates Post">
            </a>
        </figure>
        ...
        <div class="liquid-blog-item-inner">
            ...
            <a href="referral.php" class="liquid-overlay-link">Referral</a>
            ...
            <header class="liquid-lp-header">
                ...
                <h2 class="liquid-lp-title size-sm font-weight-bold h3 liquid-lp-title-clone" data-fittext="true" data-fittext-options='{ "maxFontSize": "currentFontSize" }'>
                    <a href="referral.php" data-split-text="text" data-split-options='{ "type": "lines" }'>Get 300 Naira on every referral you make</a>
                </h2>
            </header>
            
            <footer class="liquid-lp-footer">
                <h2 class="liquid-lp-title size-sm font-weight-bold h3 liquid-lp-title-original" data-fittext="true" data-fittext-options='{ "maxFontSize": "currentFontSize" }'>
                    <a href="referral.php" data-split-text="text" data-split-options='{ "type": "lines" }'>Referral</a>
                </h2>
                <a href="referral.php" class="btn btn-naked text-uppercase ltr-sp-1 size-sm font-weight-bold liquid-lp-read-more">
                    <span>
                        <span class="btn-line btn-line-before"></span>
                        <span class="btn-txt">Get Started</span>
                        <span class="btn-line btn-line-after"></span>
						...
						<div class="lqd-column col-lg-3 col-md-4 col-sm-6 col-xs-12 masonry-item">
							...
							<article class="liquid-lp liquid-blog-item liquid-blog-contents-inside liquid-blog-item-masonry liquid-blog-scheme-light liquid-blog-cloned-title h-300">
								...
								<div class="liquid-blog-item-inner">
									...
									<a href="fundAccount.php" class="liquid-overlay-link">Fund Account</a>
									...
									<header class="liquid-lp-header">
										...
										<h2 class="liquid-lp-title size-sm font-weight-bold h3 liquid-lp-title-clone" data-fittext="true" data-fittext-options='{ "maxFontSize": "currentFontSize" }'>
											<a href="fundAccount.php" data-split-text="text" data-split-options='{ "type": "lines" }'>Fund your vtuexchange account seamlessly</a>
										</h2>
									</header>
									
									<footer class="liquid-lp-footer">
										<h2 class="liquid-lp-title size-sm font-weight-bold h3 liquid-lp-title-original" data-fittext="true" data-fittext-options='{ "maxFontSize": "currentFontSize" }'>
											<a href="fundAccount.php" data-split-text="text" data-split-options='{ "type": "lines" }'>Fund Account</a>
										</h2>
										<a href="fundAccount.php" class="btn btn-naked text-uppercase ltr-sp-1 size-sm font-weight-bold liquid-lp-read-more">
											<span>
												<span class="btn-line btn-line-before"></span>
												<span class="btn-txt">Get Started</span>
												<span class="btn-line btn-line-after"></span>
			...
			<section id="about" class="vc_row bg-no-repeat pt-10" style="background-image: url(./assets/demo/bg/bg-76.svg); background-position: -90% 80%;">
				<div class="container">
					...
					data-ca-options='{"triggerHandler":"inview", "animationTarget":"all-childs", "duration":"1600", "delay":"160", "easing":"easeOutQuint", "initValues":{"translateY": 100, "opacity":0}, "animations":{"translateY": 0, "opacity":1}}'>
						...
						<div class="lqd-column col-md-12 mb-60">
							...
							<header class="fancy-title">
								...
								<h2><strong>We are here to</strong> help you</h2>
							</header>
						...
						<div class="lqd-column col-md-4">
							...
							<div class="iconbox text-left iconbox-xl iconbox-icon-image iconbox-shadow border-radius-5 px-5 pt-40 pb-55 mx-md-2 iconbox-filled-hover" style="cursor: pointer;">
								<div class="iconbox-icon-wrap">
									<span class="iconbox-icon-container mb-45">
										<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="79.5" height="70.625" viewBox="0 0 79.5 70.625"><defs xmlns="http://www.w3.org/2000/svg"><linearGradient gradientUnits="userSpaceOnUse" id="grad797996" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stop-color="#f42958"></stop><stop offset="100%" stop-color="#f42958"></stop></linearGradient></defs> <defs> <filter id="filter-seo-icon-2" x="-0.5" y="0.688" width="80" height="70.625" filterUnits="userSpaceOnUse"> <feImage preserveAspectRatio="none" x="-0.5" y="0.6875" width="80" height="70.625" result="image" xlink:href="data:image/svg+xml;base64,"></feImage> <feComposite result="composite" operator="in" in2="SourceGraphic"></feComposite> <feBlend result="blend" in2="SourceGraphic"></feBlend> </filter> </defs> <path filter="url(#filter-seo-icon-2)" d="M-0.5.688h80V71.313h-80V0.688h0ZM74.813,5.375H4.188V19.594H74.813V5.375h0ZM4.188,66.625H74.813V24.281H4.188V66.625h0ZM32.469,14.75V10.063H27.781V14.75h4.688Zm-9.375,0V10.063H18.25V14.75h4.844Zm-9.531,0V10.063H8.875V14.75h4.688Z" transform="translate(0 -0.688)"></path> </svg>
									</span>
								</div><!-- /.iconbox-icon-wrap -->
								<div class="contents">
									<h3>RESELL</h3>
									<p><span style="font-size: 18px;line-height: 30px">With your vtuexchange account you will be able to sell DataBundle, AirTime, Pay bill e.t.c at your own price and make profit.</span></p>
								</div><!-- /.contants -->
							</div><!-- /.iconbox -->
			...
			<section id="pricing" class="vc_row bg-cover pt-60 pb-100" style="background-image: url(./assets/demo/bg/bg-79.svg); background-position: center top;">
				<div class="container">
					...
					<div class="row pt-1 pt-md-0">
						...
						<div class="lqd-column col-md-12">
							...
							<header class="fancy-title text-center mb-70">
								<h6 class="text-uppercase">Editorials</h6>
								...
								<div class="liquid-blog-grid row">
									...
									<div class="lqd-column col-md-4">
										<article class="liquid-lp">
											<figure class="liquid-lp-media rounded">
												<a href="#">
													<img src="./images/dishs.jpg" alt="Blog Post">
												</a>
											</figure>
											<header class="liquid-lp-header">
												<h2 class="entry-title liquid-lp-title h5">
													<a href="#" rel="bookmark">COVID-19 accelerates worldwide adoption of connectivity tools</a>
												</h2>
												<time class="liquid-lp-date font-style-italic size-lg" datetime="2019-08-16T11:33:03+00:00">2 June</time>
											</header>
										</article>
									</div><!-- /.col-md-4 -->
									...
									<div class="lqd-column col-md-4">
										<article class="liquid-lp">
											<figure class="liquid-lp-media rounded">
												<a href="#">
													<img src="./images/cable.jpg" alt="Blog Post">
												</a>
											</figure>
											<header class="liquid-lp-header">
												<h2 class="entry-title liquid-lp-title h5">
													<a href="#" rel="bookmark">‘Without RoW tariff slash, telecoms infrastructure gaps will remain’</a>
												</h2>
												<time class="liquid-lp-date font-style-italic size-lg" datetime="2019-08-16T11:32:46+00:00">2 June</time>
											</header>
										</article>
									</div><!-- /.col-md-4 -->
									...
									<div class="lqd-column col-md-4">
										<article class="liquid-lp category-news category-rounded">
											<figure class="liquid-lp-media rounded">
												<a href="#">
													<img src="./images/globe.jpg" alt="Blog Post">
												</a>
											</figure>
											<header class="liquid-lp-header">
												<h2 class="entry-title liquid-lp-title h5">
													<a href="#" rel="bookmark">Sub-Saharan Africa’s digital exclusion woes persist, says Goodluck</a>
												</h2>
												<time class="liquid-lp-date font-style-italic size-lg" datetime="2019-08-16T11:32:32+00:00">2 June</time>
											</header>
										</article>
									</div><!-- /.col-md-4 -->
