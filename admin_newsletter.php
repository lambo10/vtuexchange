						...
						<div class="titlebar-col col-md-12 bg-white pt-10 bg-white box-shadow-1">
							<div class="row">
								...
								<div class="col-md-2 col-md-offset-1">
									<h6 class="font-size-14 font-weight-medium text-uppercase ltr-sp-2">NEWSLETTER</h6>
								</div><!-- /.col-md-2 -->
...
<script>
     $.fn.get_Admin_Users = function(){ 
		var resultJson = null;
	$.get('api/admin_get_newsletter.php',{},function(result){
		resultJson = JSON.parse(result);
		$('#adminUsers').footable({
                          "columns": $.get('json/admin_newsletter.json'),
                          "rows": resultJson
						});
