...
<body data-mobile-nav-trigger-alignment="right" data-mobile-nav-align="left" data-mobile-nav-style="modern" data-mobile-nav-shceme="gray" data-mobile-header-scheme="gray" data-mobile-nav-breakpoint="1199">
    ...
    ?>
		...
		<main id="content" class="content">
			<section class="vc_row bg-cover bg-center d-flex align-items-center py-5" style="height: 300px;" data-row-bg="images/people/5.jpg">
						...
						<div class="lqd-column col-md-12 px-4 pt-45 pb-30 bg-white box-shadow-1">
							...
							<div class="lqd-column-inner bg-white border-radius-6 px-3 px-md-4 pt-40 pb-40">
								...
								<header class="fancy-title">
									<h2 class="mb-2 font-size-30 font-weight-light">Register</h2>
									<p class="mt-0">A confarmation would be sent to the email address you provided</p>
								</header><!-- /.fancy-title -->
									...
									<form action="assets/php/mailer.php" method="post" novalidate="novalidate">
										...
										<div class="row d-flex flex-wrap">
											<div class="lqd-column col-md-6 mb-20">
												<input class="bg-gray text-dark mb-30" type="text" id="id" aria-required="true" aria-invalid="false" placeholder="Full id" required>
											...
											<div class="lqd-column col-md-6 mb-20">
												<input class="bg-gray text-dark mb-30" type="password" id="pasword" aria-required="true" aria-invalid="false" placeholder="Password" required>
