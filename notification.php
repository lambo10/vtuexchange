								...
								<div class="iconbox iconbox-side iconbox-semiround iconbox-shadow iconbox-heading-sm iconbox-filled" id="ld_icon_box_5c4e9c4475e68" data-plugin-options='{"color":"#3d59e8"}'>
									<div class="iconbox-icon-wrap">
										<span class="iconbox-icon-container">
											<img width="64px" height="64px" src="images/notification.svg" />
										</span>
									</div><!-- /.iconbox-icon-container -->
									<div class="contents">
										<h3 class="mb-2">Notification Header</h3>
										<p>Notification text Notification text Notification text Notification text</p>
									</div><!-- /.contents -->
								</div><!-- /.iconbox -->
